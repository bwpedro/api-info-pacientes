...
class Paciente {
    ...
    public function create() {
        $query = $this->conn->prepare("INSERT INTO paciente(nomecompleto, nomesocial, nomemae, nomepai, nascimento, sexo, rg, ufrg, cpf, email, datacriacao, dataalteracao) 
                                       VALUES(:nomecompleto, :nomesocial, :nomemae, :nomepai, :nascimento, :sexo, :rg, :ufrg, :cpf, :email, CURRENT_DATE, CURRENT_DATE)");
    ...
    public function update() {
        $query = $this->conn->prepare("UPDATE paciente SET nomecompleto=:nomecompleto, nomesocial=:nomesocial, nomemae=:nomemae, 
                                      nomepai=:nomepai, nascimento=:nascimento, sexo=:sexo, rg=:rg, ufrg=:ufrg, cpf=:cpf, email=:email, dataalteracao=CURRENT_DATE WHERE id=:id");

...
class Endereco {
    ...
    public function create() {
        $query = $this->conn->prepare("INSERT INTO endereco(tipo, cep, uf, cidade, bairro, logradouro, numero, complemento, donoendereco) VALUES (:tipo, :cep, :uf, :cidade, :bairro, :logradouro, :numero, :complemento, (SELECT id FROM paciente WHERE cpf = :donoendereco))");
    ...
    public function update() {
        $query = $this->conn->prepare("UPDATE endereco SET tipo=:tipo, cep=:cep, uf=:uf, cidade=:cidade, bairro=:bairro, logradouro=:logradouro, 
                                              numero=:numero, complemento=:complemento, donoendereco=:donoendereco WHERE donoendereco=:id");
        ...
        $query->bindParam(':numero',       $this->numero);
        $query->bindParam(':complemento',  $this->complemento);
        $query->bindParam(':id', $this->donoendereco);
    ...
    public function delete() {
        $query = $this->conn->prepare("DELETE from endereco WHERE donoendereco=:id");
